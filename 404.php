				...
				<main class="site-main container" id="main">
					...
					<section class="error-404 not-found my-5">
						...
						<div class="page-content">
							...
							<?php if ( SebraOne_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>

								<div class="widget widget_categories">

									<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'SebraOne' ); ?></h2>
