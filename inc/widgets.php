 ...
 */
add_filter( 'dynamic_sidebar_params', 'SebraOne_widget_classes' );

if ( ! function_exists( 'SebraOne_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function SebraOne_widget_classes( $params ) {
...
} // End of if function_exists( 'SebraOne_widget_classes' ).

add_action( 'widgets_init', 'SebraOne_widgets_init' );

if ( ! function_exists( 'SebraOne_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function SebraOne_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'SebraOne' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'SebraOne' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'SebraOne' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'SebraOne' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'SebraOne' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'SebraOne' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'SebraOne' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'SebraOne' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'SebraOne' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'SebraOne' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'SebraOne' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'SebraOne' ),
...
} // End of function_exists( 'SebraOne_widgets_init' ).
