	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'SebraOne' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'SebraOne' ); ?></th>
			</tr>
		</thead>
		<tbody>
